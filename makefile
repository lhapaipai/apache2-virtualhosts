install:
	cp a2ensite a2dissite a2lssites a2info a2mksite a2rmsite pml-update-config a2chown-mod\
		/usr/local/bin/
...
uninstall:
	rm -f /usr/local/bin/{a2ensite,a2dissite,a2lssites,a2info,a2mksite,a2rmsite,pml-update-config,a2chown-mod}
